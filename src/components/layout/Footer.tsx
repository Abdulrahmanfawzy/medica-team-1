      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[#0D6C71]">MediLink</h2>
          ...
          <div>
            <h4 className="font-semibold text-gray-800 mb-6">For Patients</h4>
          ...
          {/* Column 3: Legal */}
          <div>
            <h4 className="font-semibold text-gray-800 mb-6">Legal</h4>
            <ul className="space-y-4 text-sm text-gray-500">
              <li className="hover:text-[#0D6C71] cursor-pointer transition">
                Privacy & Policy
              </li>
